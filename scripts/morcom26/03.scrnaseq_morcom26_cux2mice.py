...
OUT_PCA_FILE  = os.path.join(OUT_RES_DIR, '03.pca_coords.tsv')
OUT_UMAP_FILE = os.path.join(OUT_RES_DIR, '03.umap_coords.tsv')
OUT_PCA_HTML  = os.path.join(OUT_FIG_DIR, '03.pca_celltype.html')
OUT_UMAP_HTML = os.path.join(OUT_FIG_DIR, '03.umap_celltype.html')

# --- config ---
CELLTYPE_COL   = 'celltype'
N_HVG          = 2000   # top highly variable genes for PCA
N_PCS          = 50     # number of PCs to compute
N_NEIGHBORS    = 15     # neighbors for UMAP graph
MARKER_SIZE    = 3
MARKER_OPACITY = 0.6
...
make_scatter_html(
    ...
    xlab='PC1', ylab='PC2',
    title='morcom26 CUX2 mice EN — PCA (colored by cell type)',
...
make_scatter_html(
    ...
    title='morcom26 CUX2 mice EN — UMAP (colored by cell type)',
