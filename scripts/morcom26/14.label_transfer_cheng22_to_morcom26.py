...
fig_umap.update_layout(
    title='morcom26 EN-L2-3-CTX & EN-L2-mix — UMAP colored by predicted L2/3 subtype (cheng22)',
    xaxis_title='UMAP1',
    yaxis_title='UMAP2',
...
fig_pca.update_layout(
    title='morcom26 EN-L2-3-CTX & EN-L2-mix — PCA colored by predicted L2/3 subtype (cheng22)',
    legend=dict(itemsizing='constant'),
    width=1400,
    height=550,
)
