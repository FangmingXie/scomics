...
PCA_FILE     = os.path.join(PROJECT_ROOT, 'local_data', 'res', 'morcom26_cux2mice', '09.pca_coords.tsv')
...
OUT_HTML     = os.path.join(OUT_FIG_DIR, '11.pca_gene_expression.html')

# --- config ---
GENES          = ['Cdh13', 'Trpc6', 'Sorcs3', 'Pcdh15', 'Chrm2',
                  'Cux1', 'Cux2', 'Rorb', 'Meis2', 'Foxp1',
                  # top higher in EN-L2-mix
                  'Tshz2', 'Tox', 'Kcnab1', 'Mgat4c', 'Sema6d', 'Clstn2', 'Vwc2l',
                  # top higher in EN-L2-3-CTX
                  'Rgs6', 'Robo1', 'Kirrel3', 'Chrm3', 'Slc9a9', 'Gria1', 'Car10', 'Kcnc2']
MARKER_SIZE    = 3
MARKER_OPACITY = 0.6
PCTILE_LOW     = 9
PCTILE_HIGH    = 95
...
# --- load ---
print(f'Loading PCA coords from {PCA_FILE}')
...
# align cells
common_cells = pca_df.index.intersection(adata.obs_names)
