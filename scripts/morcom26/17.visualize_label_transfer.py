...
OUT_FRAC_HTML        = os.path.join(OUT_FIG_DIR, '17.fraction_barplot.html')
OUT_3D_CAT_HTML      = os.path.join(OUT_FIG_DIR, '17.pca3d_metadata_cat.html')
...
stacked_bar_html(
    ...
    title='Predicted IT subtype fractions (cheng22_yoo25 → morcom26)',
...
scatter_categorical_html(
    ...
    title='morcom26 EN-L2-3-CTX, EN-L4-5-CTX & EN-L2-mix — PCA (cheng22_yoo25 reference space, categorical)',
