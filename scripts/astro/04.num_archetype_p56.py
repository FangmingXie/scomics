# Archetype number selection — P56 astrocyte cells (Gao et al. 2025)
...
FIG_NOC_PCA_CAT        = os.path.join(FIG_DIR, '04.num_archetype_p56_pca_metadata.html')
...
scatter_categorical_html(
    ...
    title=f'P56 astrocytes — PCA scatter colored by metadata (NDIM={NDIM})',
