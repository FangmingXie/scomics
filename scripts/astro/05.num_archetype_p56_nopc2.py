# Archetype number selection — P56 astrocyte cells (Gao et al. 2025), PC2 dropped
...
FIG_NOC_METRICS        = os.path.join(FIG_DIR, '05.num_archetype_p56_nopc2_metrics.png')
FIG_NOC_ARCHETYPES_REP = os.path.join(FIG_DIR, '05.num_archetype_p56_nopc2_interactive_rep.html')
FIG_NOC_PCA_CAT        = os.path.join(FIG_DIR, '05.num_archetype_p56_nopc2_pca_metadata.html')
