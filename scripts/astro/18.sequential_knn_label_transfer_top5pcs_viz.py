...
HTML_PER_AGE   = os.path.join(FIG_DIR, '18.scatter_{age}.html')
HTML_ALL_AGES  = os.path.join(FIG_DIR, '18.scatter_all_ages.html')
HTML_BARPLOT   = os.path.join(FIG_DIR, '18.archetype_abundance.html')
HTML_GENE_SCATTER = os.path.join(FIG_DIR, '18.gene_scatter.html')
...
gene_expr_scatter_html(
    ...
    gene_vals=gene_vals,
    aa=aa_vis,
    title='P56 (no PC2, joint PCA top 5 PCs) NOC=4 — archetype-specific gene expression',
