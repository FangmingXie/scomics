# Archetype number selection — P56 astrocyte cells (Gao et al. 2025), PC2 dropped, NDIM=3
...
FIG_NOC_METRICS        = os.path.join(FIG_DIR, '06.num_archetype_p56_nopc2_ndim3_metrics.png')
FIG_NOC_ARCHETYPES_REP = os.path.join(FIG_DIR, '06.num_archetype_p56_nopc2_ndim3_interactive_rep.html')
FIG_NOC_PCA_CAT        = os.path.join(FIG_DIR, '06.num_archetype_p56_nopc2_ndim3_pca_metadata.html')
