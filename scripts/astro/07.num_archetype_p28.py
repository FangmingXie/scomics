# Archetype number selection — P28 astrocyte cells (Gao et al. 2025)
# Groups/replicates: donor_name (6 donors)
# Outputs:
...
FIG_NOC_METRICS        = os.path.join(FIG_DIR, '07.num_archetype_p28_metrics.png')
FIG_NOC_ARCHETYPES_REP = os.path.join(FIG_DIR, '07.num_archetype_p28_interactive_rep.html')
FIG_NOC_PCA_CAT        = os.path.join(FIG_DIR, '07.num_archetype_p28_pca_metadata.html')
...
# load and filter to P28
adata = ad.read_h5ad(INPUT_FILE)
adata = adata[adata.obs['Age'] == P28_AGE_VAL].copy()
print(f'P28 cells: {adata.shape[0]}')
