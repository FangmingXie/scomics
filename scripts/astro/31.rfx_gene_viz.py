...
HTML_SCATTER          = os.path.join(FIG_DIR, '31.rfx_gene_scatter.html')
HTML_BOXPLOT          = os.path.join(FIG_DIR, '31.rfx_gene_boxplot.html')

# --- config ---
GENES    = ['Rfx1', 'Rfx2', 'Rfx3', 'Rfx4', 'Rfx5', 'Rfx6', 'Rfx7', 'Rfx8', 'Rfxank', 'Rfxap']
