# Archetype number selection — P56 astrocyte cells, cluster 5225_Astro-TE NN_3 (Gao et al. 2025)
...
FIG_NOC_METRICS        = os.path.join(FIG_DIR, '08.num_archetype_p56_nn3_metrics.png')
FIG_NOC_ARCHETYPES_REP = os.path.join(FIG_DIR, '08.num_archetype_p56_nn3_interactive_rep.html')
FIG_NOC_PCA_CAT        = os.path.join(FIG_DIR, '08.num_archetype_p56_nn3_pca_metadata.html')
