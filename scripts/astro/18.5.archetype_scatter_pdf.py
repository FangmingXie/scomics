...
#
# Companion to 18.4 with the same setup (P56-only, cached coords, three PC panels), but
# cells are colored by their kNN-transferred archetype label rather than by gene expression.
# Plotting-only: no recomputation of labels, PCA, or archetypes. No archetype-vertex overlay.
# Scatter points are rasterized; axes/text/legend stay vector.
...
save_archetype_scatter_pdf(
    ...
    title='P56 astrocytes (joint PCA, no PC2) — archetype labels',
