# Cross-dataset astrocyte integration: gao25 P56 (reference) → cheng22 P28/P38 only.
...
PARQUET_COMBINED = os.path.join(RES_DIR, '24.combined_labels.parquet')
PARQUET_VERTICES = os.path.join(RES_DIR, '24.archetype_vertices.parquet')
