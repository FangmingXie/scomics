# Visualization of cheng22-only cross-dataset astrocyte integration (from script 24).
...
PARQUET_COMBINED_IN   = os.path.join(PROJECT_ROOT, 'local_data', 'res', 'astro', '24.combined_labels.parquet')
ARCHETYPE_VERTICES_IN = os.path.join(PROJECT_ROOT, 'local_data', 'res', 'astro', '24.archetype_vertices.parquet')
FIG_DIR               = os.path.join(PROJECT_ROOT, 'local_data', 'fig', 'astro')
HTML_PER_DATASET      = os.path.join(FIG_DIR, '25.scatter_{dataset}.html')
HTML_ALL_DATASETS     = os.path.join(FIG_DIR, '25.scatter_all_datasets.html')
HTML_UMAP_ALL         = os.path.join(FIG_DIR, '25.umap_all_datasets.html')
HTML_BARPLOT          = os.path.join(FIG_DIR, '25.archetype_abundance.html')
