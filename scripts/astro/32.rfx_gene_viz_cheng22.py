...
HTML_SCATTER_P28      = os.path.join(FIG_DIR, '32.rfx_scatter_cheng22_P28.html')
HTML_BOXPLOT_P28      = os.path.join(FIG_DIR, '32.rfx_gene_boxplot_cheng22_P28.html')
HTML_SCATTER_P38      = os.path.join(FIG_DIR, '32.rfx_scatter_cheng22_P38.html')
HTML_BOXPLOT_P38      = os.path.join(FIG_DIR, '32.rfx_gene_boxplot_cheng22_P38.html')

# --- config ---
GENES            = ['Rfx3', 'Rfx4', 'Rfx7']
