"""Variance partitioning for cheng22 NR (P28+P38) PCA, Harmony, and VX components.

Analogous to script 38 but reads from the Harmony-corrected embedding (script 39).
...
Outputs:
  local_data/res/astro/40.pca_variance_partition.tsv
  local_data/res/astro/40.harmony_variance_partition.tsv
  local_data/res/astro/40.vx_variance_partition.tsv
  local_data/fig/astro/40.variance_partition.html
"""
...
OUT_PCA_VAR_PART     = os.path.join(OUT_RES_DIR, '40.pca_variance_partition.tsv')
OUT_HARMONY_VAR_PART = os.path.join(OUT_RES_DIR, '40.harmony_variance_partition.tsv')
OUT_VX_VAR_PART      = os.path.join(OUT_RES_DIR, '40.vx_variance_partition.tsv')
OUT_HTML             = os.path.join(OUT_FIG_DIR, '40.variance_partition.html')
...
fig_pca = stacked_bar_fig(
    pca_vp, pc_x_labels,
    title='Variance partitioning — raw PCA (cheng22 NR P28+P38)',
    xaxis_title='PCA component',
)
fig_hm = stacked_bar_fig(
    harmony_vp, hm_x_labels,
    title='Variance partitioning — Harmony-corrected PCA (cheng22 NR P28+P38)',
    xaxis_title='Harmony component',
)
fig_vx = stacked_bar_fig(
    vx_vp, vx_x_labels,
    title='Variance partitioning — varimax of Harmony (cheng22 NR P28+P38)',
