# Cln3, Slc17a7, Gad1 expression in P56 neurons from DevVIS dataset.
...
OUT_HTML     = os.path.join(OUT_FIG_DIR, '02.cln3_expr_p56_class.html')
...
print(f'P56 Glut+GABA cells: {adata.shape[0]}')
