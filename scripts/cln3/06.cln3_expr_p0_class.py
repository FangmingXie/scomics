# Cln3, Slc17a7, Gad1 expression in P0 neurons from DevVIS dataset.
...
OUT_HTML     = os.path.join(OUT_FIG_DIR, '06.cln3_expr_p0_class.html')
...
print(f'P0 Glut+GABA cells: {adata.shape[0]}')
