# Cln3, Slc17a7, Gad1 expression in P0 neuronal cells from DevVIS dataset.
...
OUT_HTML     = os.path.join(OUT_FIG_DIR, '05.cln3_expr_p0_subclass.html')
...
print(f'P0 neuronal cells: {adata.shape[0]}')
