# Cln3, Slc17a7, Gad1 expression in P7 neuronal cells from DevVIS dataset.
...
OUT_HTML     = os.path.join(OUT_FIG_DIR, '03.cln3_expr_p7_subclass.html')
...
print(f'P7 neuronal cells: {adata.shape[0]}')
