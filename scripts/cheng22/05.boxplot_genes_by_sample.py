...
INPUT_FILE   = os.path.join(PROJECT_ROOT, 'local_data', 'source', 'cheng22_yoo25', 'superdupermegaRNA_cheng22_IT_P28NR.h5ad')
OUT_FIG_DIR  = os.path.join(PROJECT_ROOT, 'local_data', 'fig', 'cheng22')
OUT_HTML     = os.path.join(OUT_FIG_DIR, '05.boxplot_genes_by_sample.html')
...
logcpm2 = np.log1p(X / adata.obs['n_counts'].values.reshape(-1, 1) * 1e4) / np.log(2)
