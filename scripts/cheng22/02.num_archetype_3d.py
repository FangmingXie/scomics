...
# Runs PCHA with a range of NOC (2-6), computing explained variance
# and archetype relative variation (bootstrap stability) to identify optimal NOC.
# Saves an interactive HTML with 2D (PC1 vs PC2) and 3D (PC1 vs PC2 vs PC3) panels.
...
FIG_NOC_METRICS = os.path.join(FIG_DIR, '02.num_archetype_3d_metrics.png')
FIG_NOC_ARCHETYPES = os.path.join(FIG_DIR, '02.num_archetype_3d_interactive.html')
