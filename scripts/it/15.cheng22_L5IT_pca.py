"""Mouse L5IT IT (cheng22, P28NR) PCA coords — no varimax (compute).
...
16.cheng22_L5IT_num_archetype.py.
...
Outputs:
  local_data/res/it/15.cheng22_L5IT_pca_coords.tsv
  local_data/res/it/15.cheng22_L5IT_pca_loadings.tsv
"""
...
OUT_PC_COORDS   = os.path.join(OUT_RES_DIR, '15.cheng22_L5IT_pca_coords.tsv')
OUT_PC_LOADINGS = os.path.join(OUT_RES_DIR, '15.cheng22_L5IT_pca_loadings.tsv')
