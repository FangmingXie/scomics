"""Archetype number selection on PCA subspace — Yoo25 mouse L2/3 IT (compute, refined).

Refinement of 06.yoo25_L23_num_archetype.py (top-5-PC baseline, no varimax):
...
Reads:  local_data/res/it/05.yoo25_L23_pca_coords.tsv
Outputs:
  local_data/res/it/06.refine.yoo25_L23_num_archetype_metrics.tsv   (metric grids w/ ARV mean/std)
  local_data/res/it/06.refine.yoo25_L23_num_archetype_plotdata.pkl  (proj + per-group archetypes)
"""
...
IN_PC_COORDS    = os.path.join(OUT_RES_DIR, '05.yoo25_L23_pca_coords.tsv')
OUT_METRICS_TSV = os.path.join(OUT_RES_DIR, '06.refine.yoo25_L23_num_archetype_metrics.tsv')
OUT_PLOTDATA    = os.path.join(OUT_RES_DIR, '06.refine.yoo25_L23_num_archetype_plotdata.pkl')
