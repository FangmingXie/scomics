"""Archetype number selection on PCA subspace — cheng22 mouse L2/3 IT (compute, refined).

Refinement of 12.cheng22_L23_num_archetype.py (top-5-PC baseline, no
...
Reads:  local_data/res/it/11.cheng22_L23_pca_coords.tsv
Outputs:
  local_data/res/it/12.refine.cheng22_L23_num_archetype_metrics.tsv   (metric grids w/ ARV mean/std)
  local_data/res/it/12.refine.cheng22_L23_num_archetype_plotdata.pkl  (proj + per-group archetypes)
"""
...
IN_PC_COORDS    = os.path.join(OUT_RES_DIR, '11.cheng22_L23_pca_coords.tsv')
OUT_METRICS_TSV = os.path.join(OUT_RES_DIR, '12.refine.cheng22_L23_num_archetype_metrics.tsv')
OUT_PLOTDATA    = os.path.join(OUT_RES_DIR, '12.refine.cheng22_L23_num_archetype_plotdata.pkl')
