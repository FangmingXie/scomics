...
Reads the computed results from 30.harmony.cheng22_L5IT_num_archetype.py and
...
Reads:
  local_data/res/it/30.harmony.cheng22_L5IT_num_archetype_metrics.tsv
  local_data/res/it/30.harmony.cheng22_L5IT_num_archetype_plotdata.pkl
Outputs:
  local_data/fig/it/30.harmony.cheng22_L5IT_num_archetype_metrics.html
  local_data/fig/it/30.harmony.cheng22_L5IT_num_archetype_interactive.html
"""
...
IN_METRICS_TSV   = os.path.join(OUT_RES_DIR, '30.harmony.cheng22_L5IT_num_archetype_metrics.tsv')
IN_PLOTDATA      = os.path.join(OUT_RES_DIR, '30.harmony.cheng22_L5IT_num_archetype_plotdata.pkl')
OUT_METRICS_HTML = os.path.join(OUT_FIG_DIR, '30.harmony.cheng22_L5IT_num_archetype_metrics.html')
OUT_INTERACTIVE  = os.path.join(OUT_FIG_DIR, '30.harmony.cheng22_L5IT_num_archetype_interactive.html')
