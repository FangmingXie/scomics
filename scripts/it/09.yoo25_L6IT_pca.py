"""Mouse L6IT IT (Yoo25, P21) PCA coords — no varimax (compute).
...
directly" archetype sweep in 10.yoo25_L6IT_num_archetype.py.
...
Outputs:
  local_data/res/it/09.yoo25_L6IT_pca_coords.tsv
  local_data/res/it/09.yoo25_L6IT_pca_loadings.tsv
"""
...
OUT_PC_COORDS   = os.path.join(OUT_RES_DIR, '09.yoo25_L6IT_pca_coords.tsv')
OUT_PC_LOADINGS = os.path.join(OUT_RES_DIR, '09.yoo25_L6IT_pca_loadings.tsv')
