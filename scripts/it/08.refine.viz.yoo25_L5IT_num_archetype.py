"""Archetype number selection on PCA subspace — Yoo25 mouse L5IT IT (plots, refined).

Reads the computed results from 08.refine.yoo25_L5IT_num_archetype.py
...
Reads:
  local_data/res/it/08.refine.yoo25_L5IT_num_archetype_metrics.tsv
  local_data/res/it/08.refine.yoo25_L5IT_num_archetype_plotdata.pkl
Outputs:
  local_data/fig/it/08.refine.yoo25_L5IT_num_archetype_metrics.html
  local_data/fig/it/08.refine.yoo25_L5IT_num_archetype_interactive.html
"""
...
IN_METRICS_TSV   = os.path.join(OUT_RES_DIR, '08.refine.yoo25_L5IT_num_archetype_metrics.tsv')
IN_PLOTDATA      = os.path.join(OUT_RES_DIR, '08.refine.yoo25_L5IT_num_archetype_plotdata.pkl')
OUT_METRICS_HTML = os.path.join(OUT_FIG_DIR, '08.refine.yoo25_L5IT_num_archetype_metrics.html')
OUT_INTERACTIVE  = os.path.join(OUT_FIG_DIR, '08.refine.yoo25_L5IT_num_archetype_interactive.html')
...
save_metrics_err_plot_html(noc_grid, ev_grid, arv_mean, arv_std, av_rep_grid,
                           ...
                           f'Archetype selection — Yoo25 mouse L5IT PCA subspace (NDIM={NDIM})',
                           OUT_METRICS_HTML)
...
scatter_per_group_html(noc_grid, ev_grid, av_rep_grid, xp_grid, aa_reps_grid,
                       ...
                       f'Per-sample archetype overlay — Yoo25 mouse L5IT PCA subspace (NDIM={NDIM})',
                       OUT_INTERACTIVE)
