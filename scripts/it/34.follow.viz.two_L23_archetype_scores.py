"""Archetype-score scatter PDF — two-dataset L2/3 IT, n=3 (plots only).

Reads the cached results from 34.follow.two_L23_archetype_scores.py and renders a static,
...
Outputs:
  local_data/fig/it/34.follow.two_L23_archetype_scores.pdf
"""
...
IN_SCORES    = os.path.join(OUT_RES_DIR, '34.follow.two_L23_archetype_scores.tsv')
IN_PCHA_XP   = os.path.join(OUT_RES_DIR, '34.follow.two_L23_pcha_xp.tsv')
IN_PCHA_AA   = os.path.join(OUT_RES_DIR, '34.follow.two_L23_pcha_aa.tsv')
OUT_PDF      = os.path.join(OUT_FIG_DIR, '34.follow.two_L23_archetype_scores.pdf')
