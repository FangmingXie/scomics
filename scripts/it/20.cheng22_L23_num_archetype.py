...
19.cheng22_L23_vx_variance_partition.tsv (cell_type R² dominates over sample + library_size): ['VX1', 'VX2', 'VX5', 'VX7', 'VX8', 'VX9'].

This script only computes and persists results; plotting lives in
20.viz.cheng22_L23_num_archetype.py (reads the outputs below).

Reads:  local_data/res/it/19.cheng22_L23_varimax_coords.tsv
Outputs:
  local_data/res/it/20.cheng22_L23_num_archetype_metrics.tsv   (metric grids)
  local_data/res/it/20.cheng22_L23_num_archetype_plotdata.pkl  (proj + per-group archetypes)
"""
...
OUT_METRICS_TSV = os.path.join(OUT_RES_DIR, '20.cheng22_L23_num_archetype_metrics.tsv')
OUT_PLOTDATA    = os.path.join(OUT_RES_DIR, '20.cheng22_L23_num_archetype_plotdata.pkl')
