"""Archetype number selection on PCA subspace — cheng22 mouse L5IT IT (compute, refined).

Refinement of 16.cheng22_L5IT_num_archetype.py (top-5-PC baseline, no
...
Reads:  local_data/res/it/15.cheng22_L5IT_pca_coords.tsv
Outputs:
  local_data/res/it/16.refine.cheng22_L5IT_num_archetype_metrics.tsv   (metric grids w/ ARV mean/std)
  local_data/res/it/16.refine.cheng22_L5IT_num_archetype_plotdata.pkl  (proj + per-group archetypes)
"""
...
IN_PC_COORDS    = os.path.join(OUT_RES_DIR, '15.cheng22_L5IT_pca_coords.tsv')
OUT_METRICS_TSV = os.path.join(OUT_RES_DIR, '16.refine.cheng22_L5IT_num_archetype_metrics.tsv')
OUT_PLOTDATA    = os.path.join(OUT_RES_DIR, '16.refine.cheng22_L5IT_num_archetype_plotdata.pkl')
