"""Mouse L2/3 IT (cheng22, P28NR) PCA coords — no varimax (compute).
...
12.cheng22_L23_num_archetype.py.
...
Outputs:
  local_data/res/it/11.cheng22_L23_pca_coords.tsv
  local_data/res/it/11.cheng22_L23_pca_loadings.tsv
"""
...
OUT_PC_COORDS   = os.path.join(OUT_RES_DIR, '11.cheng22_L23_pca_coords.tsv')
OUT_PC_LOADINGS = os.path.join(OUT_RES_DIR, '11.cheng22_L23_pca_loadings.tsv')
