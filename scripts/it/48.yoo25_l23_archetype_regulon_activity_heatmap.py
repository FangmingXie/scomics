"""P21 vs P21DR archetype x regulon-activity heatmap (Yoo25 AllAges mouse L2/3 IT).
...
from script 34's marker gene sets using the identical scoring recipe
(34.follow.two_L23_archetype_scores.py:227-244), so P21 and P21DR sit on one footing.
...
Outputs:
  local_data/fig/it/48.yoo25_l23_archetype_regulon_activity_heatmap.pdf
  local_data/res/it/48.yoo25_l23_archetype_regulon_activity_heatmap.tsv
  local_data/res/it/48.yoo25_l23_p21_archetype_scores.tsv
"""
...
OUT_PDF        = os.path.join(OUT_FIG_DIR, '48.yoo25_l23_archetype_regulon_activity_heatmap.pdf')
OUT_TSV        = os.path.join(OUT_RES_DIR, '48.yoo25_l23_archetype_regulon_activity_heatmap.tsv')
OUT_SCORES_TSV = os.path.join(OUT_RES_DIR, '48.yoo25_l23_p21_archetype_scores.tsv')
