"""Archetype number selection on PCA subspace — Yoo25 mouse L6IT IT (compute, refined).

Refinement of 10.yoo25_L6IT_num_archetype.py (top-5-PC baseline, no varimax):
...
Reads:  local_data/res/it/09.yoo25_L6IT_pca_coords.tsv
Outputs:
  local_data/res/it/10.refine.yoo25_L6IT_num_archetype_metrics.tsv   (metric grids w/ ARV mean/std)
  local_data/res/it/10.refine.yoo25_L6IT_num_archetype_plotdata.pkl  (proj + per-group archetypes)
"""
...
IN_PC_COORDS    = os.path.join(OUT_RES_DIR, '09.yoo25_L6IT_pca_coords.tsv')
OUT_METRICS_TSV = os.path.join(OUT_RES_DIR, '10.refine.yoo25_L6IT_num_archetype_metrics.tsv')
OUT_PLOTDATA    = os.path.join(OUT_RES_DIR, '10.refine.yoo25_L6IT_num_archetype_plotdata.pkl')
