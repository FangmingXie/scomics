"""Mouse L5IT IT (Yoo25, P21) PCA coords — no varimax (compute).
...
directly" archetype sweep in 08.yoo25_L5IT_num_archetype.py.
...
Outputs:
  local_data/res/it/07.yoo25_L5IT_pca_coords.tsv
  local_data/res/it/07.yoo25_L5IT_pca_loadings.tsv
"""
...
OUT_PC_COORDS   = os.path.join(OUT_RES_DIR, '07.yoo25_L5IT_pca_coords.tsv')
OUT_PC_LOADINGS = os.path.join(OUT_RES_DIR, '07.yoo25_L5IT_pca_loadings.tsv')
