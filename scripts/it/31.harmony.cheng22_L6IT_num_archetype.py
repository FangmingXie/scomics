...
31.harmony.viz.cheng22_L6IT_num_archetype.py.

Reads:
  links/it/superdupermegaRNA_cheng22_IT_P28NR.h5ad
Outputs:
  local_data/res/it/31.harmony.cheng22_L6IT_coords.tsv      (H1..H10 + Type + Sample)
  local_data/res/it/31.harmony.cheng22_L6IT_pca_coords.tsv  (raw PCA, pre-Harmony)
  local_data/res/it/31.harmony.cheng22_L6IT_loadings.tsv    (PCA gene loadings)
  local_data/res/it/31.harmony.cheng22_L6IT_num_archetype_metrics.tsv   (metric grids w/ ARV mean/std)
  local_data/res/it/31.harmony.cheng22_L6IT_num_archetype_plotdata.pkl  (proj + per-group archetypes)
"""
...
OUT_HARMONY_COORDS = os.path.join(OUT_RES_DIR, '31.harmony.cheng22_L6IT_coords.tsv')
OUT_PCA_COORDS     = os.path.join(OUT_RES_DIR, '31.harmony.cheng22_L6IT_pca_coords.tsv')
OUT_PCA_LOADINGS   = os.path.join(OUT_RES_DIR, '31.harmony.cheng22_L6IT_loadings.tsv')
OUT_METRICS_TSV    = os.path.join(OUT_RES_DIR, '31.harmony.cheng22_L6IT_num_archetype_metrics.tsv')
OUT_PLOTDATA       = os.path.join(OUT_RES_DIR, '31.harmony.cheng22_L6IT_num_archetype_plotdata.pkl')
