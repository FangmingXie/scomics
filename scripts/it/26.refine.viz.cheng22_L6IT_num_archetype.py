...
Outputs:
  ...
  local_data/fig/it/26.refine.cheng22_L6IT_num_archetype_interactive.html
"""
...
OUT_INTERACTIVE  = os.path.join(OUT_FIG_DIR, '26.refine.cheng22_L6IT_num_archetype_interactive.html')
