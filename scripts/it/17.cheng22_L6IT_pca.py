"""Mouse L6IT IT (cheng22, P28NR) PCA coords — no varimax (compute).
...
18.cheng22_L6IT_num_archetype.py.
...
Outputs:
  local_data/res/it/17.cheng22_L6IT_pca_coords.tsv
  local_data/res/it/17.cheng22_L6IT_pca_loadings.tsv
"""
...
OUT_PC_COORDS   = os.path.join(OUT_RES_DIR, '17.cheng22_L6IT_pca_coords.tsv')
OUT_PC_LOADINGS = os.path.join(OUT_RES_DIR, '17.cheng22_L6IT_pca_loadings.tsv')
