"""Archetype number selection on PCA subspace — cheng22 mouse L4 IT (compute, refined).

Refinement of 14.cheng22_L4_num_archetype.py (top-5-PC baseline, no
...
Outputs:
  local_data/res/it/14.refine.cheng22_L4_num_archetype_metrics.tsv   (metric grids w/ ARV mean/std)
  local_data/res/it/14.refine.cheng22_L4_num_archetype_plotdata.pkl  (proj + per-group archetypes)
"""
...
OUT_METRICS_TSV = os.path.join(OUT_RES_DIR, '14.refine.cheng22_L4_num_archetype_metrics.tsv')
OUT_PLOTDATA    = os.path.join(OUT_RES_DIR, '14.refine.cheng22_L4_num_archetype_plotdata.pkl')
