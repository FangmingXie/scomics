"""Archetype number selection on Harmony PCs — cheng22 mouse L4 IT (compute, refined).

Refinement of 28.cheng22_L4_harmony_num_archetype.py: the bootstrap-ARV procedure is
repeated N_OUTER times so the metrics plot can show mean ± std error bars. EV and the
per-group (rep) ARV stay single-valued. PCHA runs on the top 5 Harmony PCs (H1–H5,
NDIM=5, drop_pcs=[]).
