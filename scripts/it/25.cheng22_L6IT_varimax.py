"""Mouse L6IT IT (cheng22, P28NR) PCA + varimax rotation + variance partitioning.

Applies the Cheng22 L2/3 varimax procedure (l23_evo/18) to cheng22, restricted to
the L6IT subclass. Produces varimax coords/loadings + pre/post-varimax variance
partition reports. The post-varimax VX variance partition (cell_type vs sample vs
library_size) drives the VX_COLS selection in 26.cheng22_L6IT_num_archetype.py.
...
Outputs:
  local_data/res/it/25.cheng22_L6IT_varimax_coords.tsv
  local_data/res/it/25.cheng22_L6IT_varimax_loadings.tsv
  local_data/res/it/25.cheng22_L6IT_pc_variance_partition.tsv
  local_data/fig/it/25.cheng22_L6IT_pc_variance_partition.html
  local_data/res/it/25.cheng22_L6IT_vx_variance_partition.tsv
  local_data/fig/it/25.cheng22_L6IT_vx_variance_partition.html
"""
...
OUT_VX_COORDS   = os.path.join(OUT_RES_DIR, '25.cheng22_L6IT_varimax_coords.tsv')
OUT_VX_LOADINGS = os.path.join(OUT_RES_DIR, '25.cheng22_L6IT_varimax_loadings.tsv')
OUT_PC_VAR_TSV  = os.path.join(OUT_RES_DIR, '25.cheng22_L6IT_pc_variance_partition.tsv')
OUT_PC_VAR_HTML = os.path.join(OUT_FIG_DIR, '25.cheng22_L6IT_pc_variance_partition.html')
OUT_VX_VAR_TSV  = os.path.join(OUT_RES_DIR, '25.cheng22_L6IT_vx_variance_partition.tsv')
OUT_VX_VAR_HTML = os.path.join(OUT_FIG_DIR, '25.cheng22_L6IT_vx_variance_partition.html')
...
save_varpart_html(
    ...
    'Variance partitioning by PC — cheng22 mouse L6IT IT (pre-varimax)',
    OUT_PC_VAR_HTML,
)
...
save_varpart_html(
    ...
    'Variance partitioning by VX component — cheng22 mouse L6IT IT (post-varimax)',
    OUT_VX_VAR_HTML,
)
