"""Archetype-score scatter PDF — two-dataset L6IT, n=3 (plots only).

Reads the cached results from 36.follow.two_L6IT_archetype_scores.py and renders a static,
...
Outputs:
  local_data/fig/it/36.follow.two_L6IT_archetype_scores.pdf
"""
...
IN_SCORES    = os.path.join(OUT_RES_DIR, '36.follow.two_L6IT_archetype_scores.tsv')
IN_PCHA_XP   = os.path.join(OUT_RES_DIR, '36.follow.two_L6IT_pcha_xp.tsv')
IN_PCHA_AA   = os.path.join(OUT_RES_DIR, '36.follow.two_L6IT_pcha_aa.tsv')
OUT_PDF      = os.path.join(OUT_FIG_DIR, '36.follow.two_L6IT_archetype_scores.pdf')
