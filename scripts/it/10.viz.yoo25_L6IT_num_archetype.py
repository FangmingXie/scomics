"""Archetype number selection on PCA subspace — Yoo25 mouse L6IT IT (plots).

Reads the computed results from 10.yoo25_L6IT_num_archetype.py (top-5-PC
...
Reads:
  local_data/res/it/10.yoo25_L6IT_num_archetype_metrics.tsv
  local_data/res/it/10.yoo25_L6IT_num_archetype_plotdata.pkl
Outputs:
  local_data/fig/it/10.yoo25_L6IT_num_archetype_metrics.html
  local_data/fig/it/10.yoo25_L6IT_num_archetype_interactive.html
"""
...
IN_METRICS_TSV   = os.path.join(OUT_RES_DIR, '10.yoo25_L6IT_num_archetype_metrics.tsv')
IN_PLOTDATA      = os.path.join(OUT_RES_DIR, '10.yoo25_L6IT_num_archetype_plotdata.pkl')
OUT_METRICS_HTML = os.path.join(OUT_FIG_DIR, '10.yoo25_L6IT_num_archetype_metrics.html')
OUT_INTERACTIVE  = os.path.join(OUT_FIG_DIR, '10.yoo25_L6IT_num_archetype_interactive.html')
...
save_metrics_plot_html(noc_grid, ev_grid, av_grid, av_rep_grid,
                       NDIM, f'Archetype selection — Yoo25 mouse L6IT PCA subspace (NDIM={NDIM})',
                       OUT_METRICS_HTML)
