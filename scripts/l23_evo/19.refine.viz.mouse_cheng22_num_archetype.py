"""Archetype number selection — Cheng22 mouse L2/3 IT (plots, refined w/ bootstrap error bars).

Reads the computed results from 19.refine.mouse_cheng22_num_archetype.py and renders
the interactive HTML figures. The metrics plot shows bootstrap ARV and effective-EV
as mean ± std error bars. No computation here — rerun the compute script if inputs are missing.

Reads:
  local_data/res/l23_evo/19.refine.mouse_num_archetype_metrics.tsv
  local_data/res/l23_evo/19.refine.mouse_num_archetype_plotdata.pkl
Outputs:
  local_data/fig/l23_evo/19.refine.mouse_num_archetype_metrics.html
  local_data/fig/l23_evo/19.refine.mouse_num_archetype_interactive.html
"""
...
IN_METRICS_TSV   = os.path.join(OUT_RES_DIR, '19.refine.mouse_num_archetype_metrics.tsv')
IN_PLOTDATA      = os.path.join(OUT_RES_DIR, '19.refine.mouse_num_archetype_plotdata.pkl')
OUT_METRICS_HTML = os.path.join(OUT_FIG_DIR, '19.refine.mouse_num_archetype_metrics.html')
OUT_INTERACTIVE  = os.path.join(OUT_FIG_DIR, '19.refine.mouse_num_archetype_interactive.html')
...
save_metrics_err_plot_html(noc_grid, ev_grid, arv_mean, arv_std, av_rep_grid,
                           ...
                           f'Archetype selection — Cheng22 mouse VX subspace (NDIM={NDIM})',
                           OUT_METRICS_HTML)
