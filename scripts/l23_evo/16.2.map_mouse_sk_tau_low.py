...
Script 16.2: same as 16 but with lower temperature τ=0.01 to sharpen assignments.
Script 16 (τ=0.05) produced nearly uniform coverage (p50 eff-N=7418/9425, CV≈0).
Lower τ concentrates each mouse cell on fewer, more similar human cells.
...
Output:
  local_data/res/l23_evo/16.2.mouse_sk_tau_low_coords.tsv
  local_data/fig/l23_evo/16.2.mouse_sk_tau_low_scatter.html
"""
...
OUT_MOUSE_COORDS = os.path.join(OUT_RES_DIR, '16.2.mouse_sk_tau_low_coords.tsv')
OUT_HTML         = os.path.join(OUT_FIG_DIR, '16.2.mouse_sk_tau_low_scatter.html')
...
SK_TAU             = 0.01   # temperature for exp(S / τ) — lower than 16 (0.05) to sharpen assignments
...
scatter_categorical_html(
    ...
    title='Jorstad23 (human 20%) + Yoo25 L2/3 (mouse) — SK balanced assignment (τ=0.01)',
    out_path=OUT_HTML,
