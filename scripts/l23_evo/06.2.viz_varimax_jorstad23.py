"""Scatter plots of varimax-rotated components VX2/VX7/VX8 — Jorstad23 L2/3 IT.

Reads: local_data/res/l23_evo/05.varimax_coords.tsv
Output: local_data/fig/l23_evo/06.2.varimax_scatter.html
"""
...
OUT_HTML    = os.path.join(OUT_FIG_DIR, '06.2.varimax_scatter.html')
