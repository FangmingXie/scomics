...
Identical method to scripts/l23_evo/28.human_l23_regulon_archetype_enrichment.py, but
uses the proper background universe instead of the 2000 HVGs:
  ...
  - regulon targets  : 27.human_wang25_regulon_targets.tsv
...
Outputs:
  local_data/res/l23_evo/30.human_l23_regulon_archetype_enrichment_allgenes.tsv  (long format)
  ...
  local_data/fig/l23_evo/30.human_l23_regulon_archetype_enrichment_allgenes.html  (heatmap)
"""
...
def enrich():
    print('=== human L2/3 (full universe) ===')
    ...
    out_long = os.path.join(RES_DIR, '30.human_l23_regulon_archetype_enrichment_allgenes.tsv')
    ...
    fdr_mat.to_csv(os.path.join(RES_DIR, '30.human_l23_enrichment_allgenes_neglog10fdr.tsv'), sep='\t')
    or_mat.to_csv(os.path.join(RES_DIR, '30.human_l23_enrichment_allgenes_log2or.tsv'), sep='\t')
    ...
    out_html = os.path.join(FIG_DIR, '30.human_l23_regulon_archetype_enrichment_allgenes.html')
