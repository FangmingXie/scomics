...
Reads the computed results from 19.mouse_cheng22_num_archetype.py and renders
...
Reads:
  ...
  local_data/res/l23_evo/19.mouse_num_archetype_plotdata.pkl
Outputs:
...
IN_METRICS_TSV   = os.path.join(OUT_RES_DIR, '19.mouse_num_archetype_metrics.tsv')
IN_PLOTDATA      = os.path.join(OUT_RES_DIR, '19.mouse_num_archetype_plotdata.pkl')
