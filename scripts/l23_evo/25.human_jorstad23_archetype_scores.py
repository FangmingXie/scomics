"""Archetype scores for Jorstad23 human L2/3 IT — conservative one-vs-each Wilcoxon.

Mirrors script 21 (mouse Cheng22) for the 4 human archetypes: replaces the
one-vs-rest Wilcoxon in script 09 with a conservative one-vs-each test, then
computes per-cell archetype scores from the resulting markers.
...
Outputs:
  ...
  local_data/fig/l23_evo/25.human_archetype_scatter.html
  local_data/fig/l23_evo/25.human_archetype_scores.html
"""
...
OUT_MARKERS    = os.path.join(OUT_RES_DIR, '25.human_archetype_markers.tsv')
OUT_PCHA_XP    = os.path.join(OUT_RES_DIR, '25.human_pcha_xp.tsv')
OUT_PCHA_AA    = os.path.join(OUT_RES_DIR, '25.human_pcha_aa.tsv')
OUT_SCORES     = os.path.join(OUT_RES_DIR, '25.human_archetype_scores.tsv')
OUT_ARCH_HTML  = os.path.join(OUT_FIG_DIR, '25.human_archetype_scatter.html')
OUT_SCORE_HTML = os.path.join(OUT_FIG_DIR, '25.human_archetype_scores.html')
