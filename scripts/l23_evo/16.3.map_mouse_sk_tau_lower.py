...
Script 16.3: same as 16.2 but with even lower temperature τ=0.005.
16 (τ=0.05): p50 eff-N=7418. 16.2 (τ=0.01): p50 eff-N=235. Testing τ=0.005 to sharpen further.
...
Output:
  ...
  local_data/fig/l23_evo/16.3.mouse_sk_tau_lower_scatter.html
"""
...
OUT_MOUSE_COORDS = os.path.join(OUT_RES_DIR, '16.3.mouse_sk_tau_lower_coords.tsv')
OUT_HTML         = os.path.join(OUT_FIG_DIR, '16.3.mouse_sk_tau_lower_scatter.html')
...
SK_TAU             = 0.005  # temperature for exp(S / τ) — lower than 16.2 (0.01) to sharpen further
...
scatter_categorical_html(
    ...
    title='Jorstad23 (human 20%) + Yoo25 L2/3 (mouse) — SK balanced assignment (τ=0.005)',
    out_path=OUT_HTML,
