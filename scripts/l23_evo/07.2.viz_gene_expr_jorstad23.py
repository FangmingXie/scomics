"""Gene expression scatter on varimax axes VX2/VX7/VX8 — Jorstad23 L2/3 IT.

Same layout as script 07 but for VX2/VX7/VX8 (matching script 06.2).
...
Output:
  local_data/fig/l23_evo/07.2.gene_expr_scatter.html
"""
...
OUT_HTML     = os.path.join(OUT_FIG_DIR, '07.2.gene_expr_scatter.html')
...
gene_expr_scatter_html(
    x=None, y=None,
    gene_vals=gene_vals,
    title='Jorstad23 L2/3 IT — VX2 vs VX7 vs VX8',
    out_path=OUT_HTML,
    xp=vx_coords,
    panels=[(0, 1, 'VX2', 'VX7'), (0, 2, 'VX2', 'VX8'), (1, 2, 'VX7', 'VX8')],
    panel_3d=(0, 1, 2, 'VX2', 'VX7', 'VX8'),
)
