"""Archetype markers for Jorstad23 L2/3 IT — fixed NOC=5.

Fits PCHA at NOC=5 on the VX2/VX6–VX10 subspace, assigns each archetype the
...
OUT_MARKERS     = os.path.join(OUT_RES_DIR, '09.2.archetype_markers.tsv')
OUT_XP          = os.path.join(OUT_RES_DIR, '09.2.pcha_xp.tsv')
OUT_AA          = os.path.join(OUT_RES_DIR, '09.2.pcha_aa.tsv')
