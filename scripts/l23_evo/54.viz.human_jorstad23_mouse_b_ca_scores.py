"""Mouse B and C−A archetype scores on the human Jorstad23 PCHA embedding (plots only).

Two-panel restyling of 52.viz — identical data, identical embedding and display
conventions, visualization changes only:
...
Outputs:
  local_data/fig/l23_evo/54.human_mouse_b_ca_scores.pdf
"""
...
OUT_PDF      = os.path.join(OUT_FIG_DIR, '54.human_mouse_b_ca_scores.pdf')
...
# --- two panels: mouse Score B, and the C − A contrast ---
...
# ONLY THE POLYGON VERTEX LABELS ARE AFFECTED; THE MOUSE SCORES KEEP THEIR OWN LABELS,
# AND NO CACHED TSV IS TOUCHED.
# ===========================================================================
...
# PC1 = -PC1 ONLY (PC2 UNCHANGED), MATCHING 25.viz AND 52.viz, SO THE ARCHETYPE POLYGON
...
save_score_scatter_pdf(
    ...
    title='Jorstad23 human L2/3 IT — mouse Cheng22 archetype scores '
